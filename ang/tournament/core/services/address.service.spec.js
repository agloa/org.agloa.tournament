...
describe('address', function () {
  ...
  it('should get address data', inject(function () {
    expect(address.get("2")).toEqual({
      values: [{
          id: "1",
          contact_id: "2",
          location_type_id: "3",
  ...
  it('should get countries', () => {
    expect(address.getCountries()).toEqual({
      values: [
        {
          id: "1101",
          name: "India",
  ...
  it('should get states & provinces', () => {
    expect(address.getStateProvinces()).toEqual({
      values: [
        {
          id: "1000",
          name: "Alabama",
