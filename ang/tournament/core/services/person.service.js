angular.module('tournament').factory('person', function (crmApi4) {
  return {
    ...
    save: (person) => {
      ...
      return crmApi4('Contact', 'save', {
        ...
        chain: {
          ...
          "phoneSave": ["Phone", "save", { "records": [{ "contact_id": person.id, "id": person.phoneId, "phone": person.phone }] }],
          "addressSave": ["Address", "save", {
            "records": [{
              "contact_id": person.id, "id": person.addressId,
              "street_address": person.street_address,
              "supplemental_address_1": person.supplemental_address_1, "supplemental_address_2": person.supplemental_address_2, "supplemental_address_3": person.supplemental_address_3,
              "city": person.city, "state_province_id": person.state_province_id, "country_id": person.country_id,
              "postal_code": person.postal_code, "postal_code_suffix": person.postal_code_suffix
            }]
          }]
        }
      })
